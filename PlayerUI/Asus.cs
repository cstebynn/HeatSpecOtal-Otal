...
namespace PlayerUI
{
    public partial class Asus : UserControl
    {
        public Asus()
        {
            InitializeComponent();
        ...
        private void buttonAsusBuyNow2_Click(object sender, EventArgs e)
        {
            ...
            Specification formSpec = new Specification(model, processor, memory, storage, graphics, display, price, laptopImage, 79900);
            var dialogResult = formSpec.ShowDialog();
        ...
        private void buttonAsusBuyNow3_Click(object sender, EventArgs e)
        {
            ...
            Specification formSpec = new Specification(model, processor, memory, storage, graphics, display, price, laptopImage, 34995);
            var dialogResult = formSpec.ShowDialog();
        ...
        private void buttonAsusBuyNow4_Click(object sender, EventArgs e)
        {
            ...
            Specification formSpec = new Specification(model, processor, memory, storage, graphics, display, price, laptopImage, 65995);
            var dialogResult = formSpec.ShowDialog();
